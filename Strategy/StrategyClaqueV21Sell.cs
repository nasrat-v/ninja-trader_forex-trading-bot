...
namespace NinjaTrader.Strategy
{
    ...
    /// 
    /// </summary>
    [Description("Statrégie v2 avec ajout d'un stop loss et second exit en fonction de l'entrée et non plus en fonction de la premiere sortie - v2.1 - SELL")]
    public class StrategyClaqueV2_1_Sell : Strategy
    {
		enum StateAutomate 
		{
			PREPA,
